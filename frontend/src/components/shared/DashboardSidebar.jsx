...
const DashboardSidebar = () => {
  ...
  return (
    <aside className="flex flex-col w-64 h-screen bg-slate-200 text-slate-800">
      {/* Logo/ Header */}
      ...
      <nav className="flex-1 p-4">
          ...
          {currentUser && currentUser.isAdmin && (
            <li>
              <Link
                ...
                className="flex items-center p-2 rounded hover:bg-slate-300"
              >
        ...
        <div className="p-4 border-t border-gray-700">
          <button
            className="flex items-center w-full p-2 rounded hover:bg-slate-300"
