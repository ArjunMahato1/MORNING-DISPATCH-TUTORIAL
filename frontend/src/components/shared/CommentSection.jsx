  ...
  return (
    <div className="w-full max-w-3xl p-3 mx-auto">
      {currentUser ? (
        ...
        <div className="flex gap-1 my-5 text-sm text-gray-700">
      ...
      {allComments.length === 0 ? (
        <p className="my-5 text-sm">No comments yes!</p>
      ) : (
        <>
          <div className="flex items-center gap-1 my-5 text-sm font-semibold">
            <p>Comments</p>
