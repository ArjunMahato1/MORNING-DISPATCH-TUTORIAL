...
const Search = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      {/* Sidebar */}
      <aside className="p-6 bg-white border-r border-gray-300 shadow-md md:w-1/4">
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <Button
            type="submit"
            className="px-4 py-2 text-white bg-red-600 rounded-md shadow-lg "
          >
            Apply Filters
          </Button>
        </form>
      ...
      <div className="w-full">
        <h1 className="p-3 mt-5 text-2xl font-semibold text-slate-700">
          News Articles:
        </h1>
        ...
        <div className="flex flex-wrap gap-4 p-7">
          ...
          {showMore && (
            <button
              ...
              className="w-full text-lg text-slate-800 hover:underline p-7"
            >
              Show More
            </button>
          )}
